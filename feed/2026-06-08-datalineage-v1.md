...
The GoogleCloudDatacatalogLineageV1SearchLineageStreamingRequest schema now explicitly states that the locations parameter must contain the location provided in the parent field. While this is a description-only change, it highlights a strict validation requirement for developers using the streaming search functionality to avoid potential request errors.
